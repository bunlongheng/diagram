      ...
      <div style={{ display: "flex", gap: 10 }}>
        {LINKS.map(l => (
          <a key={l.label} className="sf-ico" href={l.href} target="_blank" rel="noopener noreferrer" title={l.label} aria-label={l.label}
            style={{ width: 38, height: 38, borderRadius: 10, display: "flex", alignItems: "center", justifyContent: "center", color: "#64748b", background: "#fff", border: "1px solid #e6e8ee", textDecoration: "none" }}>
            {l.icon}
          </a>
        ))}
      </div>
      <span style={{ fontSize: 12.5, color: "#94a3b8" }}>
        Built by <a href="https://bunlongheng.com" target="_blank" rel="noopener noreferrer" style={{ color: "#7c3aed", fontWeight: 600, textDecoration: "none" }}>Bunlong Heng</a>
      </span>
    </footer>
  );
}
